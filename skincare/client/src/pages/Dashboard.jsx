...
import { 
  ...
  Check, Sparkles, TrendingUp, Activity
} from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-10 pb-28">
        ...
        {activeTab === 'health' && <HealthSection history={analysisHistory} currentScore={currentScore} />}
...
function HealthSection({ history, currentScore }) {
